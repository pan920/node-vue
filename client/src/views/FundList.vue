...
export default {
    ...
    methods:{
        getProfile(){
            this.$axios.get('/api/profiles/list',{params: {page:this.paginations.page_index,limit:this.paginations.page_size}})
            .then(res=>{
                this.allTableData = res.data.result.docs
                this.fileterTableData = res.data.result.docs
                //设置分页数据
                this.setPaginations(res.data.total_num)
            })
